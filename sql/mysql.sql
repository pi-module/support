CREATE TABLE `{ticket}` (
  ...
  `status_financial` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0',
  `time_create`      INT(10) UNSIGNED    NOT NULL DEFAULT '0',
  `time_update`      INT(10) UNSIGNED    NOT NULL DEFAULT '0',
  `time_suggested`   INT(10) UNSIGNED    NOT NULL DEFAULT '0',
  `time_execution`   INT(10) UNSIGNED    NOT NULL DEFAULT '0',
